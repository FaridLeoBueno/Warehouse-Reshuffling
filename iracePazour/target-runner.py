...
exe = "C:\TunningBRKGA\iracePazour\PazourGRH\BuildPazourGRH.exe"
fixed_params = "false -1"
...
command = [exe] + [instance] +fixed_params.split() +cand_params

outf = open(out_file, "w")
errf = open(err_file, "w")
return_code = subprocess.check_call(command, stdout = outf, stderr = errf)
outf.close()
errf.close()
